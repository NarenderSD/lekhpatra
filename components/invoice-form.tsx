...
import type { InvoiceData, LineItem } from "@/types/invoice" // Import LineItem
...
interface InvoiceFormProps {
  ...
  calculateItemDiscount: (item: LineItem) => number // Fixed type here
  calculateItemTotal: (item: LineItem) => number // Fixed type here
      ...
      <CardContent className="p-6">
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="fromMobile">Mobile Number</Label>
                  <Input
                    id="fromMobile"
                    type="tel"
                    value={invoiceData.fromMobile}
                    onChange={(e) => handleInvoiceChange("fromMobile", e.target.value)}
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <Label htmlFor="toMobile">Mobile Number</Label>
              <Input
                id="toMobile"
                type="tel"
                value={invoiceData.toMobile}
                onChange={(e) => handleInvoiceChange("toMobile", e.target.value)}
                placeholder="Enter mobile number"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInvoiceChange("ifscCode", e.target.value)}
              />
            </div>
            <div>
              <Label htmlFor="swiftBic">SWIFT/BIC (International)</Label>
              <Input
                id="swiftBic"
                value={invoiceData.swiftBic}
                onChange={(e) => handleInvoiceChange("swiftBic", e.target.value)}
              />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Button variant="outline" onClick={addItem} className="flex items-center mt-4 bg-transparent">
        ...
        <div className="mt-6">
          ...
          <Textarea
            ...
            placeholder="Enter your terms and conditions here (e.g., payment terms, warranty, etc.)"
          />
        </div>
